            ...
            if output.get("call_self"):
                ...
                if context._has_executable_code(output):
                    ...
                    if execution_result.get("status") == "success":
                        ...
                        # ✅ CRITICAL FIX: Persist execution results to globals_schema for second iteration
                        globals_schema = context.plan_graph.graph['globals_schema']
                        for var_name, var_value in execution_data.items():
                            globals_schema[var_name] = var_value
                            print(f"✅ Persisted {var_name} for second iteration")
